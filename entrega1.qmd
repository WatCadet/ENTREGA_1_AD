...
La moda es Investigación y estudio, la finalidad principal es Investigación y estudio. Representamos gráficamente con qué finalidad se dirigen habitualmente a la Biblioteca Histórica Municipal.
...
Vemos que la moda del rango de edad de los usuarios es el intervalo de 45 a 64 años, seguido por el grupo de mayores de 65 años.
...
ggplot(data_biblio, aes(x=factor(data_biblio$Valoracion_general))) +
  geom_bar(color="blue", fill=rgb(0.1,0.4,0.5,0.7))+
...
ggplot(data_biblio, aes(x=factor(data_biblio$Valoracion_horario_apertura))) +
  geom_bar(color="blue", fill=rgb(0.1,0.4,0.5,0.7))+
...
ggplot(data_biblio, aes(x=factor(data_biblio$Valoracion_trato_atencion))) +
  geom_bar(color="blue", fill=rgb(0.1,0.4,0.5,0.7))+
...
ggplot(data_biblio, aes(x=factor(data_biblio$Valoracion_tiempo_descarga_doc_digital))) +
  geom_bar(color="blue", fill=rgb(0.1,0.4,0.5,0.7))+
...
-   Las personas de 18 a 29 años ofrecen valoraciones más altas, mientras que los otros grupos muestran mayor dispersión; sin embargo, el test de independencia indica que las variables de rango de edad y valoración general son independientes.
